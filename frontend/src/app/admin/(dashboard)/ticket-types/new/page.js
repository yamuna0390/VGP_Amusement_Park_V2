...
export default function NewTicketPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await adminTicketTypeService.createTicket({
        ...formData,
        price: priceVal,
  ...
  return (
    <div className="admin-page-container max-w-2xl mx-auto p-6">
      <div className="mb-6">
        ...
        <h1 className="text-2xl font-bold">Add Ticket Type</h1>
      </div>
      ...
      <form onSubmit={handleSubmit} className="bg-white border rounded-lg shadow-sm p-6 space-y-6">
        <div>
          ...
          <input
            ...
            placeholder="e.g. Adult Fun Pass"
          />
        </div>
        ...
        <div className="pt-4 flex justify-end">
          ...
          >
            {loading ? "Saving..." : <><Save size={18} /> Save Ticket</>}
          </button>
        </div>
      </form>
    </div>
