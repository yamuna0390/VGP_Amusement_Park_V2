...
{n:"Tea Cup",m:"Okamoto · Japan",c:"family",i:"teacup",bg:"bg-mint",d:"Climb into a colourful teacup and spin your way through a cheerful adventure. Gentle thrills, playful turns and plenty of laughter.", img: "/images/rides/teacup.jpg"},
{n:"Telecombat",m:"Okamoto · Japan",c:"family",ph:"Sky War on Telecombat",bg:"bg-lavender",d:"Take control of your own flying vehicle as you rise, dip and circle through the air. Every rider gets a playful aerial adventure.", img: "/images/rides/flyingride.jpg"},
...
{n:"Power Surge",m:"Zamperla · Italy",c:"adult",ph:"Top Gun",bg:"bg-lavender",d:"Brace yourself for powerful spins, sweeping swings and unexpected changes in direction. An electrifying mix of speed, height and adrenaline.", img: "/images/rides/bumpercars.jpg"},
{n:"Rock & Roll",m:"Okamoto · Japan",c:"adult",i:"spinner",bg:"bg-mint",d:"Get ready to spin, twist and rock through an energetic adventure. Fast rotations and lively movements deliver non-stop excitement.", img: "/images/rides/roller1.jpg"},
...
/* ---- WATER PARK (11) ---- */
{n:"Surfing Pool",m:"Aqua Kingdom",c:"water",e:"🏄",bg:"bg-sky",d:"Catch the Kingdom's rolling surf right beside the Bay of Bengal. Body-surf the swells and ride wave after wave.", img: "/images/rides/wavepool.jpg"},
{n:"Wave Pool",m:"Aqua Kingdom",c:"water",e:"🌊",bg:"bg-mint",d:"Dive into rolling waves in the Kingdom's giant wave pool. Thousands of gallons of swirling, splashing fun for everyone.", img: "/images/rides/wavepool.jpg"},
{n:"Tornado",m:"Aqua Kingdom",c:"water",e:"🌪️",bg:"bg-lavender",d:"Spiral down the giant funnel and whirl like you're inside a storm. The splashdown is worth every scream.", img: "/images/rides/waterride.jpg"},
...
{n:"River Ride",m:"Aqua Kingdom",c:"water",e:"🛟",bg:"bg-cream",d:"Grab a float and drift along the winding river. The current does the walking while you do the laughing.", img: "/images/rides/wavepool.jpg"},
