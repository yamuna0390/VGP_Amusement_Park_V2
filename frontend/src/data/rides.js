...
{n:"Crazy Plane",m:"Zamperla · Italy",c:"family",i:"plane",bg:"bg-peach",d:"Take flight as the Crazy Plane spins, rises and moves through the air. Gentle thrills with the exciting sensation of flying.", img: "/images/vgrides/Crazy Plains.JPG"},
/* ---- ADULT (13) ---- */

{n:"Flying Machine",m:"Zamperla · Italy",c:"adult",ph:"Flying Machine",bg:"bg-softyellow",d:"Take to the skies as the Flying Machine rises and circles through the air. The exciting feeling of true flight.", img: "/images/vgrides/Flying Machine.JPG"}, //
...
{n:"Giant Wheel",m:"UKD Classic",c:"adult",ph:"Ferris Wheel",bg:"bg-sky",d:"Rise high above the park and enjoy beautiful panoramic views from the top. See the whole Kingdom — and the sea — from the very top.", img: "/images/vgrides/Ferries wheel.JPG"}, //
{n:"Octopus",m:"Okamoto · Japan",c:"adult",i:"octopus",bg:"bg-peach",d:"Hold on as the giant arms spin, rise and dip in different directions. Speed and unpredictable movement make it thrillingly lively.", img: "/images/vgrides/Octobus.JPG"}, //
...
{n:"Disco '16",m:"Zamperla · Italy",c:"adult",i:"disco",bg:"bg-cream",d:"Ride a giant spinning disc that sweeps back and forth along a curved track. Rotation, speed and soaring movement in one unforgettable thrill.", img: "/images/vgrides/Disko Coaster.JPG"},
{n:"Jumping Tower",m:"Moser Rides",c:"adult",i:"tower",bg:"bg-mint",d:"Rise high above the ground before bouncing through exciting drops. Weightless moments, laughter and adventure combined.", img: "/images/vgrides/Jumping Tower.JPG"}, //
...
{n:"Deep Sea",m:"Aqua Kingdom",c:"water",e:"🤿",bg:"bg-sky",d:"Take a plunge into the deepest pool in the park. Cool off, float about and dive like a pro.", img: "/images/vgrides/Deep Sea Explorer.JPG"},
...
{n:"Kurinji Falls",m:"Aqua Kingdom",c:"water",e:"🏞️",bg:"bg-mint",d:"Stand beneath the thundering waterfall and feel the hills come to Chennai. Nature's massage, Kingdom style.", img: "/images/vgrides/Kurinji Falls.JPG"},
